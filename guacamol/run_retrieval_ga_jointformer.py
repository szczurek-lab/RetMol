...
from retrieval_ga_generator_jointformer import RetrievalGAGeneratorJoint
import guac
import guac.guacamol
from guac.guacamol.goal_directed_benchmark import GoalDirectedBenchmark, GoalDirectedBenchmarkResult
from guac.guacamol.goal_directed_generator import GoalDirectedGenerator
from guac.guacamol.benchmark_suites import goal_directed_benchmark_suite
from guac.guacamol.utils.data import get_time_string
...
def assess_goal_directed_generation(goal_directed_molecule_generator: GoalDirectedGenerator,
    ...
    benchmark_results['guacamol_version'] = guac.guacamol.__version__
...
if __name__ == '__main__':
    ...
    #insert here the path to your trained RetMol with jointformer backbone
    ...
    res_dir = os.path.join(project_home,
                           'results/guacamol/results_retrieval_ga_jointformer/{}'.format('_'.join(benchmark.name.split())))
    ...
    # init generator
    goal_directed_molecule_generator = RetrievalGAGeneratorJoint(project_home,
